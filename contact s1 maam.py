...
if want.upper() == "YES":
                ...
                while True:
                    ...
                    if x['Phone no'] == ph:
                        ...
                        if option == 1:
                            ...
                            x['First name'] = new
                            update(pos)
                            speaker.say("FIRST NAME UPDATED")
                            speaker.runAndWait()
                        ...
                        if option == 4:
                            ...
                            speaker.say(" YOU CHOOSE TO EXIT")
                            speaker.runAndWait()
    ...
    while True:
        ...
        if choice == 1:
            ...
            print('PROVIED DETAILS OF NEW CONTACT ')
